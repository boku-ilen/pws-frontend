<template>
    ...
    <svg> 
        <g v-if="loaded">
            ...
            <path v-for="path in getWeatherIcon" :key="path" :d="path" transform="translate(28 0)"/>
            <path :style="getUsbColor" :d="usbSvgPath" transform="translate(-5 0)"/>
        </g>
    </svg>
    </svg>
</template>
...
export default {
    ...
    data() {
      return {
        ...
        optimalColor: "green",
        defaultColor: "black",
        chargingSvgPath: "M9.585 2.568a.5.5 0 0 1 .226.58L8.677 6.832h1.99a.5.5 0 0 1 .364.843l-5.334 5.667a.5.5 0 0 1-.842-.49L5.99 9.167H4a.5.5 0 0 1-.364-.843l5.333-5.667a.5.5 0 0 1 .616-.09z",
        usbSvgPath: "M6 .5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5v4H6v-4ZM7 1v1h1V1H7Zm2 0v1h1V1H9ZM5.5 5a.5.5 0 0 0-.5.5v4.894a2 2 0 0 0 .336 1.11l.83 1.245c.544.816.834 1.774.834 2.754 0 .275.222.497.497.497h2.006a.497.497 0 0 0 .497-.497c0-.98.29-1.938.834-2.754l.83-1.245a2 2 0 0 0 .336-1.11V5.5a.5.5 0 0 0-.5-.5h-6Z",
        weatherStates: {
            SUNNY: [ 
    ...
    computed: {
        ...
        getUsbColor() {
            ...
            return this.getEmptySlots == this.portUsage.length ? `fill:${this.criticalColor}` : `fill:${this.criticalColor}`
        }
    }
}
</script>
