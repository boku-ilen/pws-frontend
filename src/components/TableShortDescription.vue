  ...
  <svg>
    <g>
      ...
      <image
        ...
        width="10"
        height="10"
        :href="require(`../assets/${this.getWeatherIcon}`)"
      />
      <text x="31" y="29.5" class="svgText">
        {{ this.weatherStateNames[this.weatherState] }}
      </text>
